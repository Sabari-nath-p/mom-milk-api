...
export class AnalyticsController {
  ...
  @ApiResponse({
    status: 200,
    description: "Diaper analytics retrieved successfully",
  })
  ...
  @ApiOperation({
    summary: "Get combined analytics for all activities of a baby",
  })
  @ApiParam({ name: "babyId", description: "Baby ID", type: "integer" })
  @ApiQuery({
    name: "startDate",
  ...
  @ApiResponse({
    status: 200,
    description: "Combined analytics retrieved successfully",
  })
