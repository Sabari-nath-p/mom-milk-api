...
export class SleepAnalyticsDto {
  ...
  @ApiProperty({
    example: 12.5,
    description: "Average sleep duration per day in hours",
  })
...
export class FeedAnalyticsDto {
  ...
  @ApiProperty({
    example: 2.5,
    description: "Average feeding time per day in hours",
  })
...
export class BabyAnalyticsResponseDto {
  ...
  @ApiProperty({
    example: 31,
    description: "Number of days in the analytics period",
  })
  totalDays: number;
