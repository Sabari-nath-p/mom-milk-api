...
export class BabiesController {
  ...
  @ApiOperation({
    summary:
      "Get all baby profiles for a specific user (authenticated users only)",
  })
  @ApiParam({ name: "userId", description: "User ID" })
  @ApiResponse({
    status: 200,
    description: "List of baby profiles for the user",
  })
  @ApiResponse({
    status: 401,
  ...
  @ApiResponse({
    status: 403,
    description: "Forbidden - Can only access your own babies",
  })
  @ApiResponse({ status: 404, description: "User not found" })
  ...
  @ApiParam({
    name: "gender",
    enum: Gender,
    description: "Baby gender (BOY, GIRL, OTHER)",
  })
  @ApiResponse({
    status: 200,
    description: "List of baby profiles with specified gender",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "List of baby profiles with specified blood group",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "List of baby profiles within the specified age range",
  })
  findByAgeRange(
  ...
  @ApiResponse({
    status: 200,
    description: "All baby profiles deleted successfully",
  })
  @ApiResponse({ status: 404, description: "User not found" })
  ...
  @Post("analytics")
  @ApiOperation({
    summary: "Get comprehensive baby analytics for a date range",
  })
  @ApiResponse({
    status: 200,
