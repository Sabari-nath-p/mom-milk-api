...
export class FeedLogsController {
  ...
  @ApiResponse({
    status: 200,
    description: "List of feed logs within the date range",
  })
  @ApiResponse({ status: 404, description: "Baby not found" })
  findByBabyIdAndDateRange(
    ...
    return this.feedLogsService.findByBabyIdAndDateRange(
      babyId,
      startDate,
      endDate,
    );
  ...
  @ApiParam({
    name: "feedType",
    enum: FeedType,
    description: "Feed type (BREAST, BOTTLE, OTHER)",
  })
  @ApiResponse({
    status: 200,
    description: "List of feed logs with specified feed type",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "All feed logs deleted successfully",
  })
  @ApiResponse({ status: 404, description: "Baby not found" })
  ...
  @ApiQuery({
    name: "babyId",
    required: false,
    description: "Filter by baby ID",
  })
  @ApiResponse({
    status: 200,
    description: "Paginated feed logs retrieved successfully",
  })
  findAllPaginated(
  ...
  @ApiResponse({
    status: 200,
    description: "Paginated feed logs for baby retrieved successfully",
  })
  @ApiResponse({ status: 404, description: "Baby not found" })
  findByBabyIdPaginated(
    ...
    return this.feedLogsService.findByBabyIdPaginated(
      babyId,
      pagination,
      filters,
    );
