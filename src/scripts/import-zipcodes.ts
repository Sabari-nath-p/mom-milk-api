...
class ZipcodeImporter {
     ...
     */
    async importFromExcel(filePath: string, clearExisting: boolean = true): Promise<ImportResult> {
        ...
        try {
            ...
            if (hasHeaders) {
                console.log('✓ Detected format: Excel with named headers (country, zipcode, placeName, latitude, longitude)');
                ...
                console.log('✓ Detected format: Excel with positional columns (A=country, B=zipcode, C=placeName, J=latitude, K=longitude)');
     ...
     */
    async importFromCSV(filePath: string, clearExisting: boolean = true): Promise<ImportResult> {
     ...
     */
    async import(filePath: string, clearExisting: boolean = true): Promise<ImportResult> {
...
Examples:
  ...
  npm run import:zipcodes -- --stats
    ...
    try {
        ...
        if (!filePath) {
            const excelPath = path.join(process.cwd(), 'src', 'data', 'zipcodes.xlsx');
            ...
            if (fs.existsSync(excelPath)) {
                ...
                console.error('   Please place zipcodes.xlsx or zipcodes.csv in src/data/ directory');
        ...
        console.log('\n╔══════════════════════════════════════════════════════════════════╗');
        console.log('║          Starting Zipcode Import                                 ║');
        console.log('╚══════════════════════════════════════════════════════════════════╝\n');
