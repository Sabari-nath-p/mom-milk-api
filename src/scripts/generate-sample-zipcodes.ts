...
function generateSampleZipCodesXLSX() {
    ...
    const sampleData = [
        ...
        ['US', '10001', 'New York', 'New York', 'NY', 'New York', '061', 'Manhattan', '000', 40.7128, -74.0060],
        ['US', '90210', 'Beverly Hills', 'California', 'CA', 'Los Angeles', '037', 'Beverly Hills', '000', 34.0901, -118.4065],
        ['US', '33109', 'Miami Beach', 'Florida', 'FL', 'Miami-Dade', '086', 'Miami Beach', '000', 25.7617, -80.1918],
        ['US', '60601', 'Chicago', 'Illinois', 'IL', 'Cook', '031', 'Chicago', '000', 41.8781, -87.6298],
        ['US', '94102', 'San Francisco', 'California', 'CA', 'San Francisco', '075', 'San Francisco', '000', 37.7749, -122.4194],
        ['US', '02108', 'Boston', 'Massachusetts', 'MA', 'Suffolk', '025', 'Boston', '000', 42.3601, -71.0589],
        ['US', '98101', 'Seattle', 'Washington', 'WA', 'King', '033', 'Seattle', '000', 47.6062, -122.3321],
        ['US', '75201', 'Dallas', 'Texas', 'TX', 'Dallas', '113', 'Dallas', '000', 32.7767, -96.7970],
        ['US', '30301', 'Atlanta', 'Georgia', 'GA', 'Fulton', '121', 'Atlanta', '000', 33.7490, -84.3880],
        ['US', '85001', 'Phoenix', 'Arizona', 'AZ', 'Maricopa', '013', 'Phoenix', '000', 33.4484, -112.0740]
    ];
    ...
    const simpleData = [
        ...
        ['US', '10001', 'New York', 40.7128, -74.0060],
