...
export class DiaperLogsController {
  ...
  @ApiResponse({
    status: 200,
    description: "List of diaper logs within the date range",
  })
  @ApiResponse({ status: 404, description: "Baby not found" })
  findByBabyIdAndDateRange(
    ...
    return this.diaperLogsService.findByBabyIdAndDateRange(
      babyId,
      startDate,
      endDate,
    );
  ...
  @ApiParam({
    name: "diaperType",
    enum: DiaperType,
    description: "Diaper type (SOLID, LIQUID, BOTH)",
  })
  @ApiResponse({
    status: 200,
    description: "List of diaper logs with specified diaper type",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "All diaper logs deleted successfully",
  })
  @ApiResponse({ status: 404, description: "Baby not found" })
