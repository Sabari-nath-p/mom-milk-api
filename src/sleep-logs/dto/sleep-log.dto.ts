...
export class CreateSleepLogDto {
  ...
  @ApiProperty({
    example: "2024-01-16T06:00:00.000Z",
    required: false,
    description: "End time (optional, defaults to 3 hours after start time)",
  })
  @IsDateString()
  @IsOptional()
  endTime?: string;
  ...
  @ApiProperty({
    example: "Baby slept well through the night",
    required: false,
  })
  @IsString()
  @IsOptional()
