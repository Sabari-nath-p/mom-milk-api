...
export class CreateProductDto {
    ...
    @ApiPropertyOptional({ default: 0, description: 'Used when hasVariants = false' })
    @IsOptional()
    @IsInt()
    @Min(0)
    stock?: number;
    ...
    @ApiPropertyOptional({ type: [CreateVariantDto], description: 'Required if hasVariants=true' })
    @IsOptional()
    @IsArray()
