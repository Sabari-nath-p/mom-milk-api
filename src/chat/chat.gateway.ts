...
export class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
    ...
    async handleSendMessage(
        ...
        try {
            ...
            // Get session info
            const session = await this.chatService.getOrCreateSession(senderId, data.recipientId);
    ...
    async handleMarkAsRead(
        ...
        try {
            ...
            const result = await this.chatService.markMessagesAsRead(userId, data.messageIds);
    ...
    async handleMarkAsDelivered(
        ...
        try {
            ...
            const result = await this.chatService.markMessagesAsDelivered(data.messageIds);
