...
export class RequestService {
    ...
    async sendRequestToSpecificDonor(requesterId: number, sendRequestDto: SendRequestToSpecificDonorDto): Promise<MilkRequestResponseDto> {
        ...
        const requestData = {
            ...
            neededBy: sendRequestDto.neededBy ? new Date(sendRequestDto.neededBy) : null,
