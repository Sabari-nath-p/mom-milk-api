...
export class RequestController {
  ...
  async getUserRequests(@Request() req, @Query() filters: RequestFiltersDto) {
  ...
  @ApiResponse({
    status: 403,
    description: "Only donors can view incoming requests",
  })
  ...
  @ApiResponse({
    status: 403,
    description: "No permission to update this request",
  })
  async updateRequest(
    @Request() req,
  ...
  @ApiQuery({
    name: "ableToShareMedicalRecord",
    required: false,
    description: "Filter by medical record sharing",
  })
  @ApiQuery({
    name: "isAvailable",
    required: false,
  ...
  async searchDonors(@Request() req, @Query() filters: DonorSearchFiltersDto) {
  ...
  @ApiResponse({
    status: 201,
    description: "Request sent to donor successfully",
    type: MilkRequestResponseDto,
  })
  @ApiResponse({
    status: 400,
    description: "Bad request - invalid donor or donor not available",
  })
