...
export class CreateMilkRequestDto {
  @ApiProperty({
    enum: RequestType,
    example: RequestType.MILK_REQUEST,
  ...
  @ApiProperty({
    example: "Need breast milk for newborn",
  ...
  @ApiPropertyOptional({
    example: "Urgent need for my 2-week old baby",
  ...
  @ApiPropertyOptional({
    ...
    description: "When milk is needed by",
  })
  @IsOptional()
  @IsDateString()
  neededBy?: string;
  ...
  @ApiPropertyOptional({
    example: "Willing to travel up to 10km",
...
export class UpdateMilkRequestDto extends PartialType(CreateMilkRequestDto) {
  ...
  @ApiPropertyOptional({
    example: 200.5,
    description: "Updated quantity needed in ml",
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    ...
    description: "Updated when milk is needed by",
  })
  @IsOptional()
  @IsDateString()
  neededBy?: string;
...
export class DonorSearchFiltersDto {
  ...
  @ApiPropertyOptional({
    example: true,
    description: "Filter by medical record sharing willingness",
  })
  @IsOptional()
  @IsBoolean()
  @Transform(({ value }) => {
  ...
  @ApiPropertyOptional({
    example: "12345",
    description: "Filter by donor zipcode",
  })
  @IsOptional()
  @IsString()
  zipcode?: string;
...
export class BuyerSearchFiltersDto {
  @ApiPropertyOptional({ example: 10, description: "Maximum distance in km" })
  @IsOptional()
  @IsNumber()
  @Min(1)
...
export class DonorSearchResultDto {
  ...
  @ApiProperty({
    example: 5.2,
    description:
      "Distance from buyer to donor in kilometers (sorted shortest to longest)",
  })
  distance: number;
  ...
  @ApiProperty({
    example: false,
    description:
      "Whether donor has accepted any pending request from this user",
  })
  hasAcceptedRequest: boolean;

  @ApiProperty({
    example: true,
    description: "Whether the user has already sent a request to this donor",
  })
  ...
  @ApiProperty({
    example: "+1234567890",
    description:
      "Donor phone number - only shown if donor has accepted a request from this user, otherwise null",
    nullable: true,
  })
  donorPhoneNumber: string | null;

  @ApiProperty({
    description: "Complete location information with coordinates",
  })
  location: {
    zipcode: string;
    placeName: string;
...
export class BuyerSearchResultDto {
  @ApiProperty({ description: "Buyer user information" })
  buyer: {
    id: number;
    name: string;
    email: string;
  ...
  @ApiProperty({
    example: 5.2,
    description:
      "Distance from donor to buyer in kilometers (sorted shortest to longest)",
  })
  distance: number;
  ...
  @ApiProperty({
    example: false,
    description:
      "Whether buyer has accepted any pending request from this user",
  })
  hasAcceptedRequest: boolean;
  ...
  @ApiProperty({
    example: "+1234567890",
    description:
      "Buyer phone number - only shown if donor has accepted a request from this user, otherwise null",
    nullable: true,
  })
...
export class SendRequestToSpecificDonorDto {
  ...
  @ApiProperty({
    example: "Urgent milk request for newborn",
  ...
  @ApiPropertyOptional({
    example: "My newborn needs breast milk urgently. Please help.",
  ...
  @ApiPropertyOptional({
    example: "Please contact me ASAP",
    description: "Additional notes",
  })
  @IsOptional()
  @IsString()
