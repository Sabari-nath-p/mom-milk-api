...
__decorate([
    (0, common_1.Post)('send-to-donor'),
    (0, swagger_1.ApiOperation)({ summary: 'Send a direct request to a specific donor' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Request sent to donor successfully', type: request_dto_1.MilkRequestResponseDto }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request - invalid donor or donor not available' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Donor not found' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
