...
exports.SendRequestToSpecificDonorDto = exports.NotificationDto = exports.MilkRequestResponseDto = exports.DonorSearchResultDto = exports.RequestFiltersDto = exports.DonorSearchFiltersDto = exports.UpdateAvailabilityDto = exports.AcceptRequestDto = exports.UpdateMilkRequestDto = exports.CreateMilkRequestDto = exports.UpdateZipCodeDto = exports.CreateZipCodeDto = exports.RequestType = exports.RequestStatus = exports.UserType = void 0;
...
class SendRequestToSpecificDonorDto {
}
exports.SendRequestToSpecificDonorDto = SendRequestToSpecificDonorDto;
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'Donor ID to send request to' }),
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], SendRequestToSpecificDonorDto.prototype, "donorId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Urgent milk request for newborn', description: 'Title of the request' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], SendRequestToSpecificDonorDto.prototype, "title", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'My newborn needs breast milk urgently. Please help.', description: 'Detailed description of the request' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], SendRequestToSpecificDonorDto.prototype, "description", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 500.0, description: 'Quantity needed in ml' }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], SendRequestToSpecificDonorDto.prototype, "quantity", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['LOW', 'MEDIUM', 'HIGH'], example: 'HIGH', description: 'Urgency level' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], SendRequestToSpecificDonorDto.prototype, "urgency", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '2024-01-25T10:00:00.000Z', description: 'When milk is needed by' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], SendRequestToSpecificDonorDto.prototype, "neededBy", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Please contact me ASAP', description: 'Additional notes' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], SendRequestToSpecificDonorDto.prototype, "notes", void 0);
